"""
繼承 20251206 的內容 4 fold cross validation，然後根據 MIEXP 的 data 進行調整。整合全部 session
"""
import numpy as np
import pandas as pd
...
@tee_log("training_log_20260416_13_all.txt")
def main():
    batch_size = 8
    lr = 1e-3
    epochs = 100
    ...
    for i in ids:
        for s in sessions:
            ...
            if x_all is not None:
                ...
                shutil.copyfile(best_model_path, os.path.join(subject_session_dir, "scc_13_model.pth"))
