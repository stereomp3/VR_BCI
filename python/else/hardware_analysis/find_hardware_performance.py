...
import argparse
parser = argparse.ArgumentParser(description="解析即時硬體延遲與效能 Log")
parser.add_argument("--log_file", type=str, default="log_20260812_165112.txt", help="Log 檔案路徑 (預設: log_20260812_165112.txt)")
